...
$graph:
  ...
  - class: CommandLineTool
    ...
    hints:
      DockerRequirement:
        dockerPull: ghcr.io/alexm-stfc/cwl-test-crop:latest
  ...
  - class: CommandLineTool
    ...
    hints:
      DockerRequirement:
        dockerPull: ghcr.io/alexm-stfc/cwl-test-norm-diff:latest
    baseCommand: ["python", "-m", "app"]
    arguments: []
    inputs:
      rasters:
  ...
  - class: CommandLineTool
    ...
    hints:
      DockerRequirement:
        dockerPull: ghcr.io/alexm-stfc/cwl-test-otsu:latest
    baseCommand: ["python", "-m", "app"]
    arguments: []
    inputs:
      raster:
  ...
  - class: CommandLineTool
    ...
    hints:
      DockerRequirement:
        dockerPull: ghcr.io/alexm-stfc/cwl-test-stac:latest
    baseCommand: ["python", "-m", "app"]
    arguments: []
    inputs:
      item:
